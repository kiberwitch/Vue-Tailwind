...
export default {
  ...
  data() {
    return {
      ...
      images: [
      '/kiberwitch/img/main/slider/1.png',
      '/kiberwitch/img/main/slider/2.png',
      '/kiberwitch/img/main/slider/3.png',
      '/kiberwitch/img/main/slider/4.png',
      '/kiberwitch/img/main/slider/5.png',
      '/kiberwitch/img/main/slider/6.png',
      '/kiberwitch/img/main/slider/7.png',
      '/kiberwitch/img/main/slider/8.png',
      '/kiberwitch/img/main/slider/9.png',
      '/kiberwitch/img/main/slider/10.png',
      '/kiberwitch/img/main/slider/11.png',
      '/kiberwitch/img/main/slider/12.png',
      '/kiberwitch/img/main/slider/13.png',
      ],
